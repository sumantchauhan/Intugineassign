 ...
 const Headers = () => {
    return (
        <div className="header">
            <nav className="navbar navbar-expand-lg static-top whiteHrader">
            <div className="container">
              <a className="navbar-brand" href="#" style={{marginLeft:'-100px'}}>
              <img src={Logo} alt="logo" height="50"/>
              <span style={{color:'black'}}>Intugine</span>
             </a>
             ...
             <ul className="navbar-nav ml-auto">
                ...
                <a style={{color:'black'}} className="nav-link" href="#">Brands</a>
                </li>
                <li className="nav-item">
                <a style={{color:'black'}} className="nav-link" href="#">Transporters</a>
                </li>
                <li className="nav-item">
